...
MAKEFILE = lineSegmentIntersect_mex.mk

include lineSegmentIntersect_mex.mki


SRC_FILES =  \
	lineSegmentIntersect_data.c \
	lineSegmentIntersect_initialize.c \
	lineSegmentIntersect_terminate.c \
	lineSegmentIntersect.c \
	repmat.c \
	rdivide.c \
	_coder_lineSegmentIntersect_info.c \
	_coder_lineSegmentIntersect_api.c \
	_coder_lineSegmentIntersect_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = lineSegmentIntersect_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/lineSegmentIntersect"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/lineSegmentIntersect/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/lineSegmentIntersect/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/lineSegmentIntersect/%.cu
	$(CC) $(CCFLAGS) "$<"
