...
void smcle2coord(const emlrtStack *sp, const real_T sm[10], real_T crd[16])
{
  real_T y;
  int32_T k;
  real_T delB[4];
  ...
  for (k = 0; k < 2; k++) {
    for (i0 = 0; i0 < 2; i0++) {
      crd[i0 + ((2 + k) << 1)] = sm[i0 + (k << 1)] - delB[i0 + (k << 1)];
      crd[i0 + ((4 + k) << 1)] = sm[i0 + (k << 1)] + delB[i0 + (k << 1)];
    }
  ...
  for (k = 0; k < 2; k++) {
    for (i0 = 0; i0 < 2; i0++) {
      delB[i0 + (k << 1)] = crd[i0 + ((2 + k) << 1)] + dv0[i0 + (k << 1)];
      crd[i0 + (k << 1)] = delB[i0 + (k << 1)];
    }
  ...
  for (i0 = 0; i0 < 2; i0++) {
    for (k = 0; k < 2; k++) {
      delB[k + (i0 << 1)] = crd[k + ((4 + i0) << 1)] - dv1[k + (i0 << 1)];
      crd[k + ((6 + i0) << 1)] = delB[k + (i0 << 1)];
    }
  }
}
