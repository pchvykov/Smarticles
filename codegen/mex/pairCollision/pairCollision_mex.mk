...
MAKEFILE = pairCollision_mex.mk

include pairCollision_mex.mki


SRC_FILES =  \
	pairCollision_data.c \
...
MEX_FILE_NAME_WO_EXT = pairCollision_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/pairCollision"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/pairCollision/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/pairCollision/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/pairCollision/%.cu
	$(CC) $(CCFLAGS) "$<"
